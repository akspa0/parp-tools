...
Route the current request to the correct ordered prompt in `.github/prompts/wow-viewer-world-runtime/`, then execute one narrow slice so the `WorldScene` split lands as code changes instead of another planning-only cycle.
