---
description: "Route wow-viewer migration work to the right detailed Copilot prompt and execute one narrow implementation slice now. Use when choosing between PM4/shared-I/O/world-runtime/editor/tool-cutover seams."
...
Route the current request to the correct focused prompt in `.github/prompts/`, then execute one narrow implementation slice so progress lands as code rather than repeated planning responses.
...
- `wow-viewer-m2-runtime-plan-set.prompt.md`
