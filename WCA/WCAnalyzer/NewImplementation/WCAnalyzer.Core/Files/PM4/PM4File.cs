...
namespace WCAnalyzer.Core.Files.PM4
{
    ...
    public class PM4File
    {
        ...
        /// <summary>
        /// Creates a new PM4 file
        /// </summary>
        /// <param name="chunkFactory">Chunk factory to use for creating chunks</param>
        /// <param name="logger">Optional logger</param>
        public PM4File(ChunkFactory chunkFactory, ILogger? logger = null)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Creates a new PM4 file using the default chunk factory
        /// </summary>
        /// <param name="logger">Optional logger</param>
        public PM4File(ILogger? logger = null)
            : this(new PM4ChunkFactory(logger), logger)
        {
        }
        ...
        /// <summary>
        /// Parses a PM4 file from the specified data
        /// </summary>
