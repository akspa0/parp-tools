...
namespace WCAnalyzer.Core.Files.PM4.Chunks
{
    ...
    public class MdosChunk : PM4Chunk
    {
        ...
        /// <summary>
        /// Creates a new MDOS chunk from raw data
        /// </summary>
        /// <param name="data">Raw chunk data</param>
        /// <param name="logger">Optional logger</param>
        public MdosChunk(byte[] data, ILogger? logger = null)
            : base(SIGNATURE, data, logger)
        {
        }
        
        /// <summary>
        /// Creates a new empty MDOS chunk
        /// </summary>
        /// <param name="logger">Optional logger</param>
        public MdosChunk(ILogger? logger = null)
        ...
        /// <returns>MdosStructure containing two float values</returns>
        /// <exception cref="ArgumentOutOfRangeException">If index is out of range</exception>
        public MdosStructure GetStructure(int index)
        {
