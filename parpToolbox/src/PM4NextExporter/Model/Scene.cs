namespace PM4NextExporter.Model
{
    ...
    public sealed class Scene
    {
        ...
        // Optional raw MSPI chunks; needed for MSLK span semantics and diagnostics
        ...
        public static Scene Empty(string sourcePath) => new Scene
        {
            ...
            Spis = new List<ParpToolbox.Formats.P4.Chunks.Common.MspiChunk>(),
        ...
        public static Scene FromPm4Scene(Pm4Scene pm4, string sourcePath) => new Scene
        {
            ...
            Spis = pm4.Spis ?? new List<ParpToolbox.Formats.P4.Chunks.Common.MspiChunk>(),
