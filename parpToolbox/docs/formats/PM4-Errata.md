...
- Hierarchical containers: use BoundsCenterX/Y/Z identifiers; treat `MSLK.MspiFirstIndex = -1` as container/group nodes; traverse to geometry-bearing links.
...
- `docs/formats/PM4.md` – overview and per-tile pipeline.
