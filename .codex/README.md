...
- For staged M2 runtime and renderer recovery work, keep `.codex/prompts/wow-viewer-m2-runtime-plan-set.md` and `.codex/prompts/wow-viewer-m2-runtime/*` synchronized with the GitHub-side prompt set.
- For staged `v7.5.1` and `v7.6` training recovery work, keep `.codex/prompts/wow-viewer-training-plan-set.md` and `.codex/prompts/wow-viewer-training/*` synchronized with the active training guides, dataset-builder plan, and continuity notes.
