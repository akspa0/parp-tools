...
3. deepen shared WMO ownership from root, group, `MLIQ`, and `MOBA` semantic summary into the next narrow deep-payload seam only when a fixed validation target is available
