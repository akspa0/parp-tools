...
- shared WDT semantic summary for MPHD flags, MAIN occupancy, standard `MAIN` flag distributions, string-table counts, and top-level placement counts is now real
