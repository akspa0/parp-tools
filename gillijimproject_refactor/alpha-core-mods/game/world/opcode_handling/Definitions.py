...
HANDLER_DEFINITIONS = {
    ...
    OpCode.CMSG_FLAG_QUEST: FlagQuestHandler.handle,
    OpCode.CMSG_FLAG_QUEST_FINISH: FlagQuestFinishHandler.handle,
    OpCode.CMSG_CLEAR_QUEST: ClearQuestHandler.handle,
    ...
    OpCode.CMSG_GM_INVIS: InvisHandler.handle,
    OpCode.CMSG_GHOST: GhostHandler.handle,
    OpCode.CMSG_GM_NUKE: NukeHandler.handle,
    OpCode.MSG_GM_BIND_OTHER: BindOtherHandler.handle,
    OpCode.MSG_GM_SHOWLABEL: ShowLabelHandler.handle,
    OpCode.CMSG_DBLOOKUP: DBLookupHandler.handle,
