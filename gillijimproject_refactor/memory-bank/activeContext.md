...
- current boundary:
	...
	- `WowViewerDesktopApp` still uses the current runtime-frame shape for detailed object navigation, selection resolution, and object-canvas picking, and `WowViewerWorldRuntimeBridge` is still the producer of that frame
