...
| **V16 default no-compression write profile** | **DONE (IMPLEMENTED)** — dataset build defaults now use `--codec none --clevel 0 --shuffle noshuffle` for faster rebuilds; optional Blosc compression remains available via CLI overrides. |
