...
/// <summary>
/// Map Model Filename Offsets chunk containing offsets into the MMDX chunk.
/// </summary>
public class MmidChunk : ChunkBase
{
    public override string ChunkId => "MMID";

    /// <summary>
    /// Gets the list of offsets into the MMDX chunk.
    /// </summary>
    public List<uint> Offsets { get; } = new();

    /// <summary>
    /// Gets the number of model filename offsets.
    /// </summary>
