# Archived — Active Context — wow-viewer (pre speckit-cleanup pass)

Superseded 2026-09-10 by the first real Spec 224 `speckit-cleanup` audit run (224-T201/T202).
This is the full pre-cleanup dashboard, preserved verbatim because most of its narrative content
duplicated `progress.md`'s dated entries — kept here rather than discarded per the cleanup skill's
"never delete history: archive, don't destroy" rule. The compact replacement in
`memory-bank/activeContext.md` keeps only current lane / next action / proof owner / constraints /
handoff; session narrative already lives in `progress.md`.
...
[archives](README.md) are on-demand context, never default reading.

## New lane — Spec 234 Map Save & New Map Creator (spec authored 2026-09-10)

- **Spec** at [234-map-save-new-map/spec.md](../../specs/archived/234-map-save-new-map/spec.md) (operator
...
- **T056–T059 + T064 + T066 landed 2026-09-09** (operator directives): donor-tile picker now reads
  ...
  [t056-t059](../../specs/archived/232-cartography-composition-project/evidence/t056-t059-placement-z-minimap-receipt.md),
  [t066](../../specs/archived/232-cartography-composition-project/evidence/t066-tile-rigid-cell-shift-receipt.md),
  [t064](../../specs/archived/232-cartography-composition-project/evidence/t064-wdl-edge-snap-receipt.md).
...
- **Spec + plan + tasks** at [233-marketing-capture-automation/](../../specs/archived/233-marketing-capture-automation/spec.md): a built-in, versioned camera-path overview recipe, clean-scene timed callouts, direct renderer-frame capture, future receipt and safe authoring handoff contracts.
- **P1 source implementation 2026-09-08**: **Feature Tour + Video** now starts from the existing Camera Path pane, carries the validated tour through the existing warmup gate and ffmpeg framebuffer route, hides ordinary chrome during recording, draws only timed callouts at the full-frame capture tap, and restores the prior chrome state. The Core Runtime model rejects invalid recipes and output traversal, while the handoff model emits only relative artifact references. Focused marketing tests: 12/12; Debug solution build: 0 errors. **Not runtime/visual proof**: T015 needs the operator's `FlybyUndead` warm-and-record witness. Receipts: [design](../../specs/archived/233-marketing-capture-automation/evidence/t001-design-receipt.md), [foundation](../../specs/archived/233-marketing-capture-automation/evidence/t003-t008-foundation-receipt.md), [P1 source](../../specs/archived/233-marketing-capture-automation/evidence/t009-t014-us1-source-receipt.md).
...
- **Spec + plan + tasks** at [231-editor-archaeology-ui-overhaul/](../../specs/archived/231-editor-archaeology-ui-overhaul/spec.md):
...
- **Landed 2026-09-07**: Phase 0 complete — T002 (operator scope-freeze ack), T003 (supersession
  ...
  Receipts: [evidence/](../../specs/archived/231-editor-archaeology-ui-overhaul/evidence/inventory-v3-baseline.md).
- **Phase 2 landed 2026-09-07** (86394fb6): D1 single export draw site + "Open Data I/O" links;
  D6 backgrounded JSON dumps. Receipt: [evidence/t020-t023-phase2-receipt.md](../../specs/archived/231-editor-archaeology-ui-overhaul/evidence/t020-t023-phase2-receipt.md).
- **Phases 3+4 landed 2026-09-07** (operator pushed on visible mess): D2 — workbench correlation
  ...
  [evidence/t030-t043-phase3-4-receipt.md](../../specs/archived/231-editor-archaeology-ui-overhaul/evidence/t030-t043-phase3-4-receipt.md).
- **Phase 7 landed + fix round 2026-09-07** (12cb1b82 + 4bd50b4d): layer rotation/mirror wired
  ...
  Receipt: [evidence/t070-t074-phase7-layer-rotation-receipt.md](../../specs/archived/231-editor-archaeology-ui-overhaul/evidence/t070-t074-phase7-layer-rotation-receipt.md).
- **Spec 232 T015e 2026-09-09 (MCAL alpha repair — fixes the operator's "MCLY layers on overlapped
  ...
  (folds into T015d). Receipt: [t015e MCAL alpha repair](../../specs/archived/232-cartography-composition-project/evidence/t015e-mcal-alpha-repair-receipt.md).
- **Spec 232 T015a–c 2026-09-08**: the Alpha adapter now reads the full donor lattice, applies
  ...
  Receipts: [core lattice](../../specs/archived/232-cartography-composition-project/evidence/t015a-t015b-core-lattice-receipt.md),
  [adapter route](../../specs/archived/232-cartography-composition-project/evidence/t015c-alpha-adapter-full-tile-receipt.md).
- **Spec 232 T050 2026-09-08**: picker-created layers now compose only their explicit
  ...
  Receipt: [t050 placed tiles only](../../specs/archived/232-cartography-composition-project/evidence/t050-placed-tiles-only-receipt.md).
- **Spec 232 T051 implementation 2026-09-08**: explicit placement locks are persisted and
  ...
  [t051 per-tile locks](../../specs/archived/232-cartography-composition-project/evidence/t051-per-tile-lock-implementation-receipt.md).
- **Spec 232 T053 implementation 2026-09-08**: the WL click-inspector failure was not caused by
  ...
  [t053 WL fall-through](../../specs/archived/232-cartography-composition-project/evidence/t053-wl-inspector-fallthrough-receipt.md).
- **Spec 232 T054 implementation 2026-09-08**: a no-page entry to Archaeology now defaults to
  ...
  **Still unchecked** pending a default-entry/remembered-page UI witness. Receipt:
  [t054 Map Layers default](../../specs/archived/232-cartography-composition-project/evidence/t054-archaeology-map-layers-default-receipt.md).
- **Phase 6 batch 1 landed 2026-09-07** (fbf600a1): operator amendment recorded verbatim in the
  ...
  Receipt: [evidence/p6-wiring-audit.md](../../specs/archived/231-editor-archaeology-ui-overhaul/evidence/p6-wiring-audit.md).
...
- Video-capture release hardening (2026-09-08): Capture Automation now resolves a licensed
  ...
  **Play + Video** witness. Receipt:
  [t609-video-capture-release-hardening-2026-09-08.md](../../specs/archived/223-ui-consolidation-audit/evidence/t609-video-capture-release-hardening-2026-09-08.md).
