...
[progress ledger](../progress.md) (dated session history), and [archives](README.md) are
...
[Spec 247](../../specs/archived/247-dat-capture-and-adt-export/spec.md) ·
[US3 receipt](../../specs/archived/247-dat-capture-and-adt-export/evidence/us3-dat-to-lk-adt-2026-09-20.md) ·
[US5 receipt](../../specs/archived/247-dat-capture-and-adt-export/evidence/us5-dat-as-cartography-layer-2026-09-20.md)

Old note: [247 DAT Capture & LK ADT Export](../../specs/archived/247-dat-capture-and-adt-export/spec.md)** —
...
Receipts: [first-v22](../../specs/archived/237-adt-v26-terrain/evidence/first-v22-dat-render-2026-09-20.md) ·
[v23 icecrown](../../specs/archived/237-adt-v26-terrain/evidence/real-v23-dat-icecrown-2026-09-20.md).
...
|---|---|---|---|---|
| 1 | [246 modern M2 camera paths + benchmarking](../../specs/archived/246-modern-m2-camera-paths-and-benchmarking/spec.md) · Epic 3 | `MD21` CASC M2 camera tracks as playable paths; path-driven modern renderer benchmark with legacy-shaped receipt | `speckit-plan`, FR-002 diagnosis first: locate where modern cameras drop (era dispatch vs `MD21` conversion — `M2ModelReader` already has a `0x74` modern camera branch) | operator run for FPS + path witness |
| 2 | [242 WMO instancing](../../specs/archived/242-wmo-instancing-performance/spec.md) · Epic 3 | Per-placement instancing under scene lights; modern data currently one draw call per placement (~5.5 FPS, 16,431 WMO draw calls) | `speckit-plan`; no new god-class members; 246 is its measurement vehicle | operator before/after run |
| 3 | [243 modern→legacy conversion](../../specs/archived/243-modern-to-legacy-map-conversion/spec.md) · Epic 4 | One-way modern → **LK v18** + **Alpha 0.5.3**, multi-layer alpha/texture-id merge, batch maps, low-touch UI, optional assets | **Plan authored 2026-09-18** (`plan.md`/`research.md`/`data-model.md`/`contracts/`/`quickstart.md`); next `speckit-tasks` | operator client-load witness |
| 4 | [244 modern liquid flow](../../specs/archived/244-modern-liquid-flow/spec.md) · Epic 4 | WDT `MAI2` `liquidFlowTexture` (R = +Y west, G = −X south, 128 = zero) → viewer liquid context + one shared flow datum + legacy disposition | `speckit-plan`; confirm magnitude scaling against a real flow texture | operator visual check |
| 5 | [245 modern chunk survey](../../specs/archived/245-modern-chunk-completeness-survey/spec.md) · Epic 4 | Inventory every discarded modern chunk + per-chunk legacy build-in feasibility via alpha-mask/texture-id re-expression, loss stated | `speckit-plan`; reproducible corpus-walk receipt | self (counts) |
...
[2026-09-11](../../specs/archived/224-speckit-governance/evidence/cleanup-2026-09-11.md) ·
[2026-09-10](../../specs/archived/224-speckit-governance/evidence/cleanup-2026-09-10.md).
...
`specs/archived/237-adt-v26-terrain/evidence/dat-glb-export-and-record-2026-09-19.md`. **Still open**:
...
[236-scene-lighting-doodad-performance/spec.md](../../specs/archived/236-scene-lighting-doodad-performance/spec.md) — Implementation active on branch `v0.5.4-dev`.
...
- **Verification**:
  ...
  - Receipt: `specs/archived/236-scene-lighting-doodad-performance/evidence/phase1-shading-fix.md`.

## Prior lane — Spec 235 Legacy MDX/M2 Rendering (1.0.0-3.0.1) — Phases 0–4 Implemented & Receipted (2026-09-11)

[235-legacy-mdx-m2-rendering/spec.md](../../specs/archived/235-legacy-mdx-m2-rendering/spec.md) — Implementation complete for Phases 0 through 4 on branch `235-legacy-mdx-m2-rendering`.
...
- **Unit Tests & Build**:
  ...
  - Full solution build: 0 errors.
- **Receipt**: [phase1-reader-unification.md](../../specs/archived/235-legacy-mdx-m2-rendering/evidence/phase1-reader-unification.md).
- **2.0.0 .mdx -> .m2 Resolution & UV/Vertex Layout Fix (2026-09-12)**:
  ...
  - Evidence receipt: [2.0.0-mdx-m2-rendering-fix.md](../../specs/archived/235-legacy-mdx-m2-rendering/evidence/2.0.0-mdx-m2-rendering-fix.md).
...
- **Skybox Blending & Transparent Cutout Materials Corrections (2026-09-12)**:
  ...
  - Evidence receipt: [skybox-blending-and-transparent-materials-fix.md](../../specs/archived/235-legacy-mdx-m2-rendering/evidence/skybox-blending-and-transparent-materials-fix.md).
- **Bone Quaternion Normalization & AlphaKey Cutout Material Transfer Corrections (2026-09-13)**:
  ...
  - Evidence receipt: [quaternion-normalization-and-alphakey-transfer-fix.md](../../specs/archived/235-legacy-mdx-m2-rendering/evidence/quaternion-normalization-and-alphakey-transfer-fix.md).
- **Creature Variant & Replaceable Texture Resolution Corrections (2026-09-13)**:
  ...
  - Evidence receipt: [creature-variant-and-replaceable-texture-resolution-fix.md](../../specs/archived/235-legacy-mdx-m2-rendering/evidence/creature-variant-and-replaceable-texture-resolution-fix.md).
- **2.0.0 M2 Animation Playback, Sequence Resolution, and Character Geoset/Texture Fix (2026-09-13)**:
  ...
  - Evidence receipt: [2.0.0-animation-and-character-geoset-fix.md](../../specs/archived/235-legacy-mdx-m2-rendering/evidence/2.0.0-animation-and-character-geoset-fix.md).

## Current lane — Spec 236 Unified Scene Lighting, Doodad Performance & Client-Constrained World Pipeline (v0.5.4-dev)

[236-scene-lighting-doodad-performance/spec.md](../../specs/archived/236-scene-lighting-doodad-performance/spec.md) — Authored on branch `v0.5.4-dev`.
...
- **Phase 2 WMO emitted-light slice (2026-09-16)**:
  ...
  - Receipt: `specs/archived/236-scene-lighting-doodad-performance/evidence/phase2-wmo-light-casting-slice.md`; T011 checked.
- **Phase 2 terrain light-casting slice + ambient/sun contract (2026-09-18)**:
  ...
  - Receipt: `specs/archived/236-scene-lighting-doodad-performance/evidence/phase2-light-casting.md`; T010/T012 checked.
- **Phase 2 doodad/model external-light consumer — FR-007 (2026-09-18)**:
  ...
  - Receipt: `specs/archived/236-scene-lighting-doodad-performance/evidence/phase2-doodad-light-consumer.md`; T013 still open on that boundary, Gate 2 operator-owned.
