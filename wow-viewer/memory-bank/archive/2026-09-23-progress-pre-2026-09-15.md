# Progress — wow-viewer (archived entries 2026-09-06 … 2026-09-13)

Moved out of `progress.md` by the 2026-09-23 reconciliation. History only; spec paths now resolve under `specs/archived/`.
...
- **Verification**:
  ...
  - Evidence receipt: `specs/archived/235-legacy-mdx-m2-rendering/evidence/2.0.0-animation-and-character-geoset-fix.md`.
...
- **Verification**:
  ...
  - `dotnet build WowViewer.slnx -c Debug`: 0 errors.
  - Evidence receipt written: `specs/archived/235-legacy-mdx-m2-rendering/evidence/quaternion-normalization-and-alphakey-transfer-fix.md`.
...
- **Verification**:
  ...
  - `dotnet build WowViewer.slnx -c Debug`: 0 errors.
  - Evidence receipt written: `specs/archived/235-legacy-mdx-m2-rendering/evidence/skybox-blending-and-transparent-materials-fix.md`.
...
- **Verification**:
  ...
  - Evidence receipt written: `specs/archived/235-legacy-mdx-m2-rendering/evidence/2.0.0-mdx-m2-rendering-fix.md`.
...
- **Validation**:
  ...
  - Governance receipt written: `specs/archived/235-legacy-mdx-m2-rendering/evidence/phase1-reader-unification.md`.
...
- Completed the 224-T201 receipt audit that failed on a rate limit on 2026-09-10. **233 clean**
  ...
  **231 clean** (0 un-checked): T001's "still open" notes in two receipts were superseded by
  ...
  [cleanup-2026-09-11.md](../../specs/archived/224-speckit-governance/evidence/cleanup-2026-09-11.md).
...
- **Findings (all code-evidenced, written up in
  [235/research.md](../../specs/archived/235-legacy-mdx-m2-rendering/research.md))**: `ResolveMdxProfile` is dead
...
- Operator directive: MDX/M2 rendering for the 1.0.0-3.0.1 client range is "very much
  ...
  [235-legacy-mdx-m2-rendering](../../specs/archived/235-legacy-mdx-m2-rendering/spec.md) on new branch
...
- **Caught and corrected a near-duplication mid-authoring**: before finalizing, checking
  `specs/archived/status-history/2026-09-06-active-epics.md` surfaced Spec 104 (legacy-m2-rendering, 1.0.0-2.4.3, full plan/
...
- Compacted `memory-bank/activeContext.md` (188 → ~65 lines; had re-grown from a 2026-09-06
  ...
  [archive/2026-09-10-pre-cleanup-active-context.md](2026-09-10-pre-cleanup-active-context.md).
- **Operator bug/gap report, recorded verbatim-intent, not yet investigated**: (1) no-water
  ...
  [232's tasks.md](../../specs/archived/232-cartography-composition-project/tasks.md); item 4 filed as Phase 8
  T080 in [231's tasks.md](../../specs/archived/231-editor-archaeology-ui-overhaul/tasks.md). **Operator also
  ...
  cleanup pass closes.
- Cleanup report: [specs/archived/224-speckit-governance/evidence/cleanup-2026-09-10.md](../../specs/archived/224-speckit-governance/evidence/cleanup-2026-09-10.md).
...
- Operator directive: use the existing WDL magnetization mechanism to blend composed tile borders
  ...
  Receipt: [t064](../../specs/archived/232-cartography-composition-project/evidence/t064-wdl-edge-snap-receipt.md).
...
- Operator directives landed: (T056) donor-tile picker now reads ADT-name order xx_yy — the old
  ...
  Receipt: [t056-t059](../../specs/archived/232-cartography-composition-project/evidence/t056-t059-placement-z-minimap-receipt.md).
...
- Root-caused the operator's report that texture layers broke on overlapped maps after the T015c
  ...
  [t015e-mcal-alpha-repair-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t015e-mcal-alpha-repair-receipt.md).
...
- **Operator gate remains open**: this is not a recorded video, visual/UI timing, encoder playback,
  ...
  [design](../../specs/archived/233-marketing-capture-automation/evidence/t001-design-receipt.md),
  [foundation](../../specs/archived/233-marketing-capture-automation/evidence/t003-t008-foundation-receipt.md),
  [P1 source](../../specs/archived/233-marketing-capture-automation/evidence/t009-t014-us1-source-receipt.md).
...
- **T609 remains unchecked**: actual with-UI/no-UI and camera-path video recording, output playback,
  ...
  Receipt: [t609-video-capture-release-hardening-2026-09-08.md](../../specs/archived/223-ui-consolidation-audit/evidence/t609-video-capture-release-hardening-2026-09-08.md).
...
- **T054 remains unchecked** pending an operator UI witness for default entry and remembered
  ...
  [t054-archaeology-map-layers-default-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t054-archaeology-map-layers-default-receipt.md).
...
- **T053 remains unchecked** pending an operator witness that opens the same WL inspector with
  ...
  [t053-wl-inspector-fallthrough-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t053-wl-inspector-fallthrough-receipt.md).
...
- **Next implementation**: T051 per-tile locks. **Separate operator gate**: T015d seam-free
  ...
  [t050-placed-tiles-only-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t050-placed-tiles-only-receipt.md).
...
- **T051 remains unchecked** until the operator supplies a minimap capture that shows the badge
  ...
  [t051-per-tile-lock-implementation-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t051-per-tile-lock-implementation-receipt.md).

## 2026-09-08 — Spec 232 T015 full-tile seam-repair route

- Restored the missing Spec Kit design set for [Spec 232](../../specs/archived/232-cartography-composition-project/spec.md):
...
- **Next**: T015d's DeadminesInstance seam screenshot and cell-nudge witness remain operator-owned;
  ...
  [t015a-t015b-core-lattice-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t015a-t015b-core-lattice-receipt.md),
  [t015c-alpha-adapter-full-tile-receipt.md](../../specs/archived/232-cartography-composition-project/evidence/t015c-alpha-adapter-full-tile-receipt.md).
...
- Selection highlight is now the model's red wireframe instead of a bounding box
  ([WorldScene.cs](../../src/viewer/WoWViewer/Terrain/WorldScene.cs) selection block; box fallback only
...
- **Spec 231 authored per operator directive** (speckit; implementation deferred to a fresh
  session): [231-editor-archaeology-ui-overhaul/](../../specs/archived/231-editor-archaeology-ui-overhaul/spec.md)
...
- Added [Spec 228](../../specs/archived/228-source-decomposition/plan.md) planning artifacts. The first source
...
[memory-bank/archive](README.md), not discarded.
