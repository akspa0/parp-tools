"""V16 Terrain Model — minimap image → full terrain mesh patch.
...
class V16Model(nn.Module):
    """V16 terrain model — minimap → terrain mesh.
...
# Backward-compatible alias for legacy V15 scripts still importing V15Model.
V15Model = V16Model
