"""Canonical v50 owner for evaluating one paired-store tile with RGB-only WDL inference."""
...
from harvester.spec103.v7_inputs import wdl_lattice_from_height257
from harvester.v50.contracts import release_identity, require_store_release, validate_release
from harvester.v50.wdl_prior_infer import load_model, predict_rgb
...
def main() -> int:
    ap = argparse.ArgumentParser(description="v50 RGB-only WDL evaluation")
    ...
    report = {"schema": "v50-wdl-evaluation-v1", **release_identity(args.release), "source_row": args.row, "source": source,
