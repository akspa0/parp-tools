...
| `universal-image-to-terrain-plan-2026-07-19.md` | planned | Spec 114 contract reset: arbitrary raster to normalized relief/mesh; failed WoW-only checkpoint measured and rejected; universal curriculum/student tasks defined. | Active terrain-model architecture owner. Implement raster/mesh and multi-family curriculum contracts before training. |
