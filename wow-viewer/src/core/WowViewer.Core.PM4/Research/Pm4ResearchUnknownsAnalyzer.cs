...
public static class Pm4ResearchUnknownsAnalyzer
{
    ...
    public static Pm4UnknownsReport AnalyzeDirectory(string inputDirectory)
    {
        ...
        [
            ...
            BuildDistribution("MSLK.TypeFlags", typeFlagsCounts, null, "Partial real-data semantics: 0x03=M2 top surfaces, 0x10=interior WMO floors, 0x12=exterior WMO solid surfaces. Corpus closure and field-ownership validation remain open."),
        ...
        [
            ...
            new("MSLK.TypeFlags and Subtype meaning", "partial", $"Observed guided buckets: 0x03=M2 tops, 0x10=interior WMO floors, 0x12=exterior WMO solids; TypeFlags distinct={typeFlagsCounts.Count}, Subtype distinct={subtypeCounts.Count}", "Verify the observed buckets corpus-wide, then disambiguate how Subtype refines them and whether any offset ownership assumptions need revision."),
            ...
            new("MSHD header field meaning", "open", $"Field00 distinct={mshdField00Counts.Count}, Field04 distinct={mshdField04Counts.Count}, Field08 distinct={mshdField08Counts.Count}", "Tile-coordinate packing has now been ruled out for Field04 on the development corpus; next step is correlating the reusable Field04 buckets with object families, nav-region archetypes, and authoring patterns."),
