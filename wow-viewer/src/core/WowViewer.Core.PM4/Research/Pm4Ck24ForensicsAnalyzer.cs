...
public static class Pm4Ck24ForensicsAnalyzer
{
    ...
    public static Pm4Ck24ForensicsReport Analyze(Pm4ResearchDocument document, uint ck24)
    {
        ...
        return new Pm4Ck24ForensicsReport(
            ...
            linkGroups.Count,
            selectedSurfaces.Select(static surface => surface.MscnRefIndex).Distinct().Count(),
            ...
            selectedSurfaces.Select(static surface => surface.MscnRefIndex).Distinct().Order().ToList(),
            overallPlacement,
            linkGroups,
            notes,
        ...
        int? tileY)
    {
        ...
        return new Pm4ForensicsLinkGroupReport(
            ...
            surfaceRows.Select(static row => row.MscnRefIndex).Distinct().Order().ToList(),
