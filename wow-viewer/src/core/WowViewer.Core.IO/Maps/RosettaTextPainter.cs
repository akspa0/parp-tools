...
public static class RosettaTextPainter
{
    ...
    public static List<int> BuildColumnMasks(string text)
    {
        ...
        {
            if (!Glyphs.TryGetValue(c, out int[]? rows) && !Glyphs.TryGetValue(char.ToUpperInvariant(c), out rows))
            {
    ...
    {
        // 5x7 Handwriting / Cursive Script font.
        ...
        // Uppercase (Cursive / Handwriting flourish)
        Add('A', 0b00110, 0b01001, 0b10001, 0b11111, 0b10001, 0b10001, 0b01111);
        Add('B', 0b11110, 0b10001, 0b10001, 0b11110, 0b10001, 0b10001, 0b11110);
        Add('C', 0b01111, 0b10000, 0b10000, 0b10000, 0b10000, 0b10001, 0b01110);
        Add('D', 0b11110, 0b10001, 0b10001, 0b10001, 0b10001, 0b10001, 0b11110);
        Add('E', 0b01111, 0b10000, 0b11110, 0b10000, 0b10000, 0b10001, 0b01111);
        Add('F', 0b11111, 0b00100, 0b01110, 0b00100, 0b00100, 0b00100, 0b00100);
        Add('G', 0b01111, 0b10000, 0b10000, 0b10111, 0b10001, 0b10001, 0b01111);
        Add('H', 0b10001, 0b10001, 0b10001, 0b11111, 0b10001, 0b10001, 0b10011);
        Add('I', 0b11111, 0b00100, 0b00100, 0b00100, 0b00100, 0b00100, 0b11111);
        Add('J', 0b00011, 0b00010, 0b00010, 0b00010, 0b00010, 0b10010, 0b01100);
        Add('K', 0b10010, 0b10100, 0b11000, 0b11100, 0b10110, 0b10010, 0b10001);
        Add('L', 0b01100, 0b00100, 0b00100, 0b00100, 0b00100, 0b00101, 0b01110);
        Add('M', 0b11011, 0b10101, 0b10101, 0b10101, 0b10001, 0b10001, 0b10011);
        Add('N', 0b11001, 0b10101, 0b10011, 0b10001, 0b10001, 0b10001, 0b10011);
        Add('O', 0b01110, 0b10001, 0b10001, 0b10001, 0b10001, 0b10001, 0b01111);
        Add('P', 0b11110, 0b10001, 0b10001, 0b11110, 0b10000, 0b10000, 0b10000);
        Add('Q', 0b01110, 0b10001, 0b10001, 0b10001, 0b10011, 0b10001, 0b01111);
        Add('R', 0b11110, 0b10001, 0b10001, 0b11110, 0b10100, 0b10010, 0b10011);
        Add('S', 0b01111, 0b10000, 0b01110, 0b00001, 0b00001, 0b10001, 0b01110);
        Add('T', 0b11111, 0b00100, 0b00100, 0b00100, 0b00100, 0b00100, 0b00100);
        Add('U', 0b10001, 0b10001, 0b10001, 0b10001, 0b10001, 0b10001, 0b01111);
        Add('V', 0b10001, 0b10001, 0b10001, 0b10001, 0b01010, 0b00100, 0b00110);
        Add('W', 0b10001, 0b10001, 0b10001, 0b10101, 0b10101, 0b01010, 0b01011);
        Add('X', 0b10001, 0b10001, 0b01010, 0b00100, 0b01010, 0b10001, 0b10011);
        Add('Y', 0b10001, 0b10001, 0b10001, 0b01111, 0b00001, 0b00010, 0b01100);
        Add('Z', 0b11111, 0b00010, 0b00100, 0b01110, 0b01000, 0b10000, 0b11111);

        // Lowercase (Cursive Handwriting with ascenders & descenders)
        Add('a', 0b00000, 0b00000, 0b01110, 0b00001, 0b01111, 0b10001, 0b01111);
        Add('b', 0b10000, 0b10000, 0b11110, 0b10001, 0b10001, 0b10001, 0b11110);
        Add('c', 0b00000, 0b00000, 0b01111, 0b10000, 0b10000, 0b10001, 0b01110);
        Add('d', 0b00001, 0b00001, 0b01111, 0b10001, 0b10001, 0b10001, 0b01111);
        Add('e', 0b00000, 0b00000, 0b01110, 0b10001, 0b11111, 0b10000, 0b01111);
        Add('f', 0b00110, 0b01001, 0b01000, 0b11110, 0b01000, 0b01000, 0b01000);
        Add('g', 0b00000, 0b00000, 0b01111, 0b10001, 0b01111, 0b00001, 0b01110);
        Add('h', 0b10000, 0b10000, 0b11110, 0b10001, 0b10001, 0b10001, 0b10011);
        Add('i', 0b00100, 0b00000, 0b01100, 0b00100, 0b00100, 0b00100, 0b01110);
        Add('j', 0b00010, 0b00000, 0b00110, 0b00010, 0b00010, 0b10010, 0b01100);
        Add('k', 0b10000, 0b10000, 0b10010, 0b10100, 0b11000, 0b10100, 0b10011);
        Add('l', 0b01100, 0b00100, 0b00100, 0b00100, 0b00100, 0b00100, 0b00110);
        Add('m', 0b00000, 0b00000, 0b11011, 0b10101, 0b10101, 0b10001, 0b10011);
        Add('n', 0b00000, 0b00000, 0b11110, 0b10001, 0b10001, 0b10001, 0b10011);
        Add('o', 0b00000, 0b00000, 0b01110, 0b10001, 0b10001, 0b10001, 0b01111);
        Add('p', 0b00000, 0b00000, 0b11110, 0b10001, 0b11110, 0b10000, 0b10000);
        Add('q', 0b00000, 0b00000, 0b01111, 0b10001, 0b01111, 0b00001, 0b00011);
        Add('r', 0b00000, 0b00000, 0b10110, 0b11001, 0b10000, 0b10000, 0b10000);
        Add('s', 0b00000, 0b00000, 0b01111, 0b10000, 0b01110, 0b00001, 0b11110);
        Add('t', 0b00100, 0b00100, 0b01110, 0b00100, 0b00100, 0b00100, 0b00110);
        Add('u', 0b00000, 0b00000, 0b10001, 0b10001, 0b10001, 0b10001, 0b01111);
        Add('v', 0b00000, 0b00000, 0b10001, 0b10001, 0b10001, 0b01010, 0b00110);
        Add('w', 0b00000, 0b00000, 0b10001, 0b10101, 0b10101, 0b01010, 0b01011);
        Add('x', 0b00000, 0b00000, 0b10001, 0b01010, 0b00100, 0b01010, 0b10011);
        Add('y', 0b00000, 0b00000, 0b10001, 0b10001, 0b01111, 0b00001, 0b01110);
        Add('z', 0b00000, 0b00000, 0b11111, 0b00010, 0b00100, 0b01000, 0b11111);
        ...
        Add('/', 0b00001, 0b00010, 0b00100, 0b00100, 0b01000, 0b10000, 0b10000);
        Add('\\', 0b10000, 0b01000, 0b00100, 0b00100, 0b00010, 0b00001, 0b00001);
        Add(':', 0b00000, 0b01100, 0b01100, 0b00000, 0b01100, 0b01100, 0b00000);
        Add(',', 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b01100, 0b01000);
        return glyphs;
    }
}
