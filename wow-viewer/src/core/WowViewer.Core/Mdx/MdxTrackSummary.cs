...
public sealed class MdxTrackSummary
{
    public MdxTrackSummary(string tag, int keyCount, uint interpolationType, int globalSequenceId, int? firstKeyTime, int? lastKeyTime)
    {
