...
public sealed class MdxGeosetAnimationTrackSummary
{
    public MdxGeosetAnimationTrackSummary(string tag, int keyCount, uint interpolationType, int globalSequenceId, int? firstKeyTime, int? lastKeyTime)
    {
