...
public sealed class MdxNodeTrackSummary
{
    public MdxNodeTrackSummary(string tag, int keyCount, uint interpolationType, int globalSequenceId, int? firstKeyTime, int? lastKeyTime)
    {
