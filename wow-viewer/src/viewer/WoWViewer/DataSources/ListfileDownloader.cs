...
public static class ListfileDownloader
{
    ...
    private static readonly string CacheDir =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "WoWViewer");
    ...
    public static async Task<string?> GetListfilePathAsync(bool forceDownload = false)
    {
        ...
        if (needsDownload)
        {
            ...
            try
            {
                ...
                http.DefaultRequestHeaders.UserAgent.ParseAdd("WoWViewer/1.0");
