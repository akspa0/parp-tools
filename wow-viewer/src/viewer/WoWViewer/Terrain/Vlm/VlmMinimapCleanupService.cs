...
public static class VlmMinimapCleanupService
{
    ...
    {
        // WoWViewer's MCCV PNG export preserves raw file-order bytes in the PNG
    ...
    {
        using SixLabors.ImageSharp.Image<Rgba32> source = SixLabors.ImageSharp.Image.Load<Rgba32>(sourceMinimapPath);
        using SixLabors.ImageSharp.Image<Rgba32> mccv = SixLabors.ImageSharp.Image.Load<Rgba32>(mccvMapPath);
        return RemoveMccvTint(source, mccv);
    }

    public static byte[] RemoveMccvTint(SixLabors.ImageSharp.Image<Rgba32> source, SixLabors.ImageSharp.Image<Rgba32> mccv)
    {
        using SixLabors.ImageSharp.Image<Rgba32> working = source.Clone();
        using SixLabors.ImageSharp.Image<Rgba32> overlay = mccv.Clone();
    ...
    {
        // Match WoWViewer's terrain shader: RGB encodes the tint color around mid-gray,
