...
{
    public const string DefaultDevelopmentMapDirectory = WowViewer.Core.PM4.Services.Pm4CoordinateService.DefaultDevelopmentMapDirectory;
    ...
    {
        string mapDirectory = WowViewer.Core.PM4.Services.Pm4CoordinateService.ResolveMapDirectory(inputDirectory ?? DefaultDevelopmentMapDirectory);
