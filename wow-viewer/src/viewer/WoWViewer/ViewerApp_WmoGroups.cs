...
public partial class ViewerApp
{
    ...
    void IViewerAppHost.NormalizeStandaloneWmoGroupSelection(WmoRenderer wmoRenderer) => NormalizeStandaloneWmoGroupSelection(wmoRenderer);
    ...
    void IViewerAppHost.ToggleStandaloneWmoGroupHighlight(int renderGroupIndex) => ToggleStandaloneWmoGroupHighlight(renderGroupIndex);
