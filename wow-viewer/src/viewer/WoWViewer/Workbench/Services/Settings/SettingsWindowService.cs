...
/// <summary>
/// Settings window: interface, camera defaults and authoritative fog controls.
...
internal sealed partial class SettingsWindowService
{
    ...
    internal SettingsWindowService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see SettingsWindowService.Host.cs.

    internal bool _showSettingsWindow;

    internal void DrawSettingsWindow()
    {
    ...
    /// </summary>
    internal void DrawAuthoritativeFogControls(bool showDescription = true)
    {
        if (showDescription)
