...
// MinimapAndStatusService: members moved from ViewerApp_MinimapAndStatus.cs; this file keeps that file's using directives so every
...
internal sealed partial class MinimapAndStatusService
{
    ...
    internal bool TryGetActiveMinimapState(
    ...
    internal void DrawInteractiveMinimapSurface(
    ...
    internal void ClampMinimapPanOffset()
    {
        float camTileX = (WoWConstants.MapOrigin - _camera.Position.X) / MinimapWorldTileSize;
        float camTileY = (WoWConstants.MapOrigin - _camera.Position.Y) / MinimapWorldTileSize;
    ...
    internal void ToggleFullscreenMinimap()
    {
    ...
    internal void DrawMinimapWindow()
    {
    ...
    /// </summary>
    internal void DrawMinimapContent(int loadedTileCount, string? mapName, List<(int tx, int ty)> existingTiles, Func<int, int, bool> isTileLoaded)
    {
    ...
    internal void DrawFullscreenMinimap()
    {
