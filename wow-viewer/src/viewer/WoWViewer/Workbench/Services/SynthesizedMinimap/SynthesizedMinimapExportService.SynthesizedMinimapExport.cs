...
// SynthesizedMinimapExportService: members moved from ViewerApp_SynthesizedMinimapExport.cs; this file keeps that file's using directives so every
...
internal sealed partial class SynthesizedMinimapExportService
{
    ...
    internal void PrepareSynthesizedMinimapExportDialogInputs()
    {
    ...
    internal void DrawSynthesizedMinimapExportDialog()
    {
    ...
    internal void DrawSynthesizedMinimapExportContent(bool showCloseButton = false)
    {
