...
/// <summary>
/// Dataset catalog panel: browsing and opening harvested datasets.
...
/// </summary>
internal sealed partial class DatasetCatalogService
{
    private readonly IViewerAppHost _host;

    internal DatasetCatalogService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see DatasetCatalogService.Host.cs.

    private readonly List<DatasetVersionCatalogEntry> _datasetVersions = new();
    internal string _datasetCatalogRoot = Path.Combine(OutputDir, "datasets");
    internal string _selectedDatasetVersionRoot = string.Empty;
    internal string _activeDatasetVersionRoot = string.Empty;
    internal bool _wantSelectDatasetCatalogRoot;

    internal void DrawDatasetVersionSettingsContent()
    {
    ...
    internal void RefreshDatasetCatalog()
    {
