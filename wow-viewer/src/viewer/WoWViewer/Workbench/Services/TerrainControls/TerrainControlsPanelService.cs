...
/// <summary>
/// Terrain controls panel: terrain workbench selection and chunk grid, terrain adjustment, weak-signal and stratigraphy controls, terrain lab tab.
...
internal sealed partial class TerrainControlsPanelService
{
    ...
    internal TerrainControlsPanelService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see TerrainControlsPanelService.Host.cs.
