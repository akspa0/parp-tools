...
/// <summary>
/// Taxi panel: selected taxi node/route controls, taxi-actor model override UI and the taxi tab.
...
internal sealed partial class TaxiPanelService
{
    ...
    internal TaxiPanelService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see TaxiPanelService.Host.cs.
