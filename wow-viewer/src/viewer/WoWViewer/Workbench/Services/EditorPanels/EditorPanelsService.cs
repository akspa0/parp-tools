...
/// <summary>
/// Editor panels: editor content, placement authoring, terrain-template and chunk-manipulator plugin panels, Rosetta object library, archaeology editor tasks and imports, generated-map loading.
...
internal sealed partial class EditorPanelsService
{
    ...
    internal EditorPanelsService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see EditorPanelsService.Host.cs.
    ...
    internal void LoadGeneratedNewMap(string outputDir, string mapName, int baseTileX, int baseTileY, int tileRows, int tileCols)
    {
    ...
    internal void DrawArchaeologyEditorTasksSubTab()
    {
    ...
    internal void DrawRosettaObjectLibrarySubTab()
    {
    ...
    internal void DrawArchaeologyEditorImportsSubTab()
    {
