...
// InvestigationService: members moved from ViewerApp_Investigation.cs; this file keeps that file's using directives so every
...
internal sealed partial class InvestigationService
{
    ...
    internal VisualInvestigationMode _visualInvestigationMode = VisualInvestigationMode.Auto;
    internal bool _showMcnkFlagOverlay;
    internal bool _showMcnkWeakCorners = true;
    internal McnkOverlayFlags _mcnkOverlayFlags = McnkOverlayFlags.Impassable;
    internal int _lastMcnkOverlayChunkCount;
    internal int _lastMcnkWeakCornerCount;
    ...
    internal void DrawVisualInvestigationToolbox(bool showWorldObjectRangeControls)
    {
    ...
    internal void DrawVisualInvestigationModeButton(VisualInvestigationMode mode, string label, string tooltip)
    {
    ...
    internal void DrawTerrainChunkInvestigationPanel(bool defaultOpen)
    {
    ...
    internal void DrawWlLiquidInvestigationPanel(bool defaultOpen)
    {
        if (_worldScene == null)
            return;
    ...
    internal void DrawLitInvestigationPanel(bool defaultOpen)
    {
        if (_worldScene == null)
            return;
    ...
    internal bool ShouldShowHoveredAssetInfoForInvestigation(HoveredAssetInfo info)
    {
    ...
    internal static string BuildTerrainChunkTextureSummary(
    ...
    internal bool TryFindWlLiquidBodyByKey(string bodyKey, out WlLiquidBody? body)
    {
        body = null;
    ...
    internal bool TryResolveHoveredWlLiquidBody(HoveredAssetInfo hoveredInfo, out WlLiquidBody? body)
    {
        body = null;
    ...
    internal bool IsWlListIsolationActive
        => _wlLayerListIsolationEnabled && !string.IsNullOrWhiteSpace(_wlLayerSelectedBodyKey);

    internal bool ShouldIncludeWlBodyInUiList(WlLiquidBody body)
    {
        if (!IsWlListIsolationActive)
            return true;
    ...
    internal void SetSelectedWlLiquidBody(WlLiquidBody body, bool isolateInList, bool focusInspectWorkspace, string? statusMessage = null)
    {
    ...
    internal void ClearSelectedWlLiquidBody(bool clearListIsolation)
    {
