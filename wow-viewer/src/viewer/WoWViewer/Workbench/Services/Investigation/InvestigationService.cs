...
/// <summary>
/// Visual investigation: investigation modes, toolbox, terrain chunk investigation panel and MCNK diagnostics.
...
internal sealed partial class InvestigationService
{
    ...
    internal InvestigationService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see InvestigationService.Host.cs.
