...
using static WoWViewer.WorkspacesService;

namespace WoWViewer;

/// <summary>
/// Workbench and inspector panels: right sidebar, workbench tabs and pages, inspector context/world pages, docked shell panels, selection and camera panels, quick sections, converters and utilities tabs.
...
internal sealed partial class WorkbenchPanelsService
{
    ...
    internal WorkbenchPanelsService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see WorkbenchPanelsService.Host.cs.


    internal void DrawLegacyRightSidebar()
    {
    ...
    /// </summary>
    internal void DrawUnifiedInspectorContent()
    {
    ...
    internal void DrawDockedShellPanelsForLane(ShellPanelLane lane, float sidebarHeight)
    {
    ...
    internal bool DrawSelectedObjectInspectorSection(bool defaultOpen = true)
    {
        bool hasSelectedPm4 = _worldScene?.Pm4Overlay.HasSelectedPm4Object == true;
    ...
    /// future shell pass.
    /// </summary>
    internal void NormalizeWorkbenchStateAfterLoad()
    {
        switch (_activeTopTab)
        {
    ...
    internal void OpenWorkbenchTab(WorkbenchTab topTab, int bottomIndex = -1)
    {
    ...
    internal void OpenWorkbenchTab(ModelBottomTab tab)
    {
    ...
    internal void OpenWorkbenchTab(WorldBottomTab tab)
    {
    ...
    internal void OpenWorkbenchTab(ToolsBottomTab tab)
    {
        switch (tab)
        {
    ...
    internal void OpenWorkbenchTab(UtilitiesBottomTab tab)
    {
    ...
    internal bool IsWorkbenchUtilityVisible(UtilitiesBottomTab tab)
    {
    ...
    internal void DrawConvertersSubTabContent()
    {
