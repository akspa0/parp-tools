...
/// <summary>
/// Camera paths: recording, editing, playback and the camera-path overlay.
...
internal sealed partial class CameraPathsService
{
    ...
    internal CameraPathsService(IViewerAppHost host)
    {
        _host = host;
    }

    // Host bridge: see CameraPathsService.Host.cs.
    ...
    internal readonly M2CameraPathDocument _cameraPath = new();
    ...
    internal CameraPathPreloadState? _cameraPathPreload;
    ...
    internal sealed class CameraPathPreloadState
    {
    ...
    internal void DrawCapturePanelContent()
    {
    ...
    internal void DrawCameraPathWindow()
    {
    ...
    internal bool HandleCameraPathKeyboardInput(IKeyboard keyboard, bool ctrlDown, bool shiftDown)
    {
    ...
    internal void StopCameraPathPlayback()
    {
        _cameraPathPlaying = false;
        _cameraPathTimeSeconds = 0;
        _cameraPathVideoCapturePending = false;
    ...
    internal void UpdateCameraPathPlayback(double dt)
    {
        if (!_cameraPathPlaying)
            return;
    ...
    internal void UpdateCameraPathPreload()
    {
    ...
    internal void EndCameraPathPreload()
    {
        _cameraPathVideoCapturePending = false;
        if (_worldScene != null)
