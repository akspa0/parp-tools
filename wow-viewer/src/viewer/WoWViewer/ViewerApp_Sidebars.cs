...
public partial class ViewerApp
{
    ...
    void IViewerAppHost.DrawWorkspaceBarsPanelContent() => DrawWorkspaceBarsPanelContent();
    ...
    void IViewerAppHost.DrawFixedSidebarWidthControl(string label, ref float width, bool isLeftSidebar, float displayWidth, string tooltip) => DrawFixedSidebarWidthControl(label, ref width, isLeftSidebar, displayWidth, tooltip);
