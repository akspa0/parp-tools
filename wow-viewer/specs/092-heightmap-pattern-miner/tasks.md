...
- [x] T004 Sample configurable patch sizes and strides.
...
- [ ] T010 Join V23 validation error maps against mined motif IDs.
- [ ] T011 Export a V23 curriculum manifest if motif/error clustering is useful.
