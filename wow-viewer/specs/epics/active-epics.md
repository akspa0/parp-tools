...
**Members:** 238 (**v0.6** CASC data source — local + remote CDN via TACTSharp), 239 (**v0.6** modern client assets — FileDataID-era WDT/ADT/M2/WMO/DB2, depends on 238), 237 (**v0.6** ADT v26 — brand-new terrain format first seen 2026-09-16 in the first WoW: Forever build; first analysis is ours — AHDR family, read + render from tile files alone; corpus on hand; wireframe fast path first; independent of 238/239), 197 (split ADT/targets, active), 221 (converter validation harness, active),
