...
- [ ] T007 User-run: train on selected representative patterns with a group holdout.
- [ ] T008 User-run: evaluate generated-prior V8 output through the label-free harness.
