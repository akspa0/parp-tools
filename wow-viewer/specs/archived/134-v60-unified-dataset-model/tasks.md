...
**Input**: Design documents from `specs/archived/134-v60-unified-dataset-model/`
...
- [x] T001 [P] Record the control, albedo-gate, and experiment contracts in `specs/archived/134-v60-unified-dataset-model/contracts/`.
- [x] T002 [P] Record the entities and ownership boundaries in `specs/archived/134-v60-unified-dataset-model/data-model.md`.
- [x] T003 [P] Record implementation decisions and rejected harvest-first alternatives in `specs/archived/134-v60-unified-dataset-model/research.md`.
- [x] T004 [P] Write PowerShell-ready staged execution instructions in `specs/archived/134-v60-unified-dataset-model/quickstart.md`.
...
- [ ] T008 Add JSON contract validation coverage for `specs/archived/134-v60-unified-dataset-model/contracts/*.schema.json`.
...
- [ ] T017 [US1] **USER RUNS** the bounded full-taxonomy control command from `specs/archived/134-v60-unified-dataset-model/quickstart.md`.
...
- [x] T019a [P] [US2] Define the `objectified_terrain_shadow_256`, clean `terrain_shadow_256`, and
  `object_contamination_mask_256` contract in `specs/archived/134-v60-unified-dataset-model/contracts/`.
...
- [ ] T023f [DEFERRED] [US2] Define the footprint-guided `v60-object-marker-v1` candidate and marker-map
  contracts in `specs/archived/134-v60-unified-dataset-model/data-model.md` and
...
- [ ] T025 [US3] Record the held-out result and ambiguity cases in the experiment report before real-data work in `specs/archived/134-v60-unified-dataset-model/`.
...
- [ ] T038 [US5] Record the transfer decision and next bounded batch in `specs/archived/134-v60-unified-dataset-model/quickstart.md` or a run-local report.
...
- [ ] T041 [US6] Expand controls only in response to a recorded failure mode in `specs/archived/134-v60-unified-dataset-model/`.

## Phase 8: Polish and cross-cutting validation

- [ ] T042 [P] Add JSON schema validation to the focused v60 test suite in `data-harvester/tests/v60/`.
- [ ] T043 [P] Update `specs/archived/134-v60-unified-dataset-model/quickstart.md` whenever an executable CLI lands.
- [ ] T044 Run `git diff --check` and focused Python/C# checks after each bounded implementation slice.
- [ ] T045 Keep `specs/archived/134-v60-unified-dataset-model/spec.md`, `plan.md`, and `tasks.md` aligned with the current gate status.
