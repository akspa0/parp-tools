...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Local CASC shipped; residue US2 CDN streaming, US3 builds by id. Successor: [Epic 248](../../248-epic-formats-and-conversion/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-D2.md)); they are not implementation authority.
...
- **First consumer**: Spec 237 needs local reads of the textures/models the DAT v26 tiles reference (all **33/33** `ATEX` textures and **285/285** `ADOO` models (`.m2` and `.wmo`) resolve to FileDataIDs through the vendored community listfile (`specs/archived/237-adt-v26-terrain/evidence/scripts/names_to_fdid_v26.py`, 2026-09-16)).
