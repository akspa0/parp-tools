...
**Input**: `specs/archived/238-casc-data-source/` (spec, plan, research, quickstart)
...
- [ ] T003 [P] Record the finding that existing `libs/*` gitlinks have no .gitmodules entries (not repaired here) in specs/archived/238-casc-data-source/research.md
...
- [ ] T006 🌐 Era survey over the CDN/mirrors: one real build per root era (6.x legacy root, 8.2+ root, newest retail), pass/fail per era, library decision (TACTSharp or fallback with license resolved), and questions for Marlamin, in specs/archived/238-casc-data-source/evidence/phase0-era-survey.md
...
- [ ] T018 [US1] 💾 Gate: SC-001 on a real local build (≥1000 ids) and SC-003 (≥200 ids per surveyed era), naming the reference tool and version, in specs/archived/238-casc-data-source/evidence/phase1-local-verify.md
...
- [ ] T030 [US4] 🌐 Gate: SC-006 (known key → valid header; unknown key → no bytes; refresh unlocks without restart) appended to specs/archived/238-casc-data-source/evidence/phase2-remote.md
...
- [ ] T032 [US3] 🌐 Record which configured hosts serve which surveyed historical builds (R6) in specs/archived/238-casc-data-source/evidence/phase2-historical.md
...
- [ ] T037 [US6] 🌐 Gate: SC-004 timings on a remote-build map, SC-007 (MPQ 0.5.3 + 3.3.5 load time ±5%, full suite green) in specs/archived/238-casc-data-source/evidence/phase3-viewer.md

## Phase 9: Polish

- [ ] T038 [P] Write docs/architecture/casc-data-source.md (modes, cache, Principle VII interpretation, era table)
- [ ] T039 [P] Document the `casc` commands, then diff docs/CLI-TOOLS.md and specs/archived/238-casc-data-source/quickstart.md against the real parser
