...
undefined4 __fastcall FUN_0071fb20(int param_1,uint param_2,uint *param_3)
    ...
    if (uVar1 * 0x1c + uVar3 <= param_2) {
      ...
      if (uVar1 != 0) {
        ...
        do {
          ...
          uVar3 = *(uint *)(iVar4 + 8);
          if (param_2 < uVar3) goto LAB_0071fb36;
          if (param_2 < uVar3 + *(int *)(iVar4 + 4) * 8) goto LAB_0071fb53;
          if (*(int *)(iVar4 + 4) == 0) {
            iVar5 = 0;
          }
          else {
          ...
          *(int *)(iVar4 + 8) = iVar5;
          ...
          if (param_2 < uVar3) goto LAB_0071fb36;
          if (param_2 < uVar3 + *(int *)(iVar4 + 0xc) * 4) goto LAB_0071fb53;
          if (*(int *)(iVar4 + 0xc) == 0) {
            iVar5 = 0;
          }
          else {
          ...
          *(int *)(iVar4 + 0x10) = iVar5;
          ...
          if (param_2 < uVar3) goto LAB_0071fb36;
          if (param_2 < uVar3 + *(int *)(iVar4 + 0x14) * 2) goto LAB_0071fb53;
          if (*(int *)(iVar4 + 0x14) == 0) {
            iVar5 = 0;
          }
          else {
