...
**Input**: Design documents from `specs/archived/109-v50-clean-room-audit/`
...
- [x] T003 [P] Record approved generated-data roots and protected roots in `wow-viewer/specs/archived/109-v50-clean-room-audit/research.md`
...
- [x] T005 Validate Spec 109 requirements, plan, schemas, and command examples in `wow-viewer/specs/archived/109-v50-clean-room-audit/`
...
- [x] T049 Prepare the exact user-run cleanup apply command in `wow-viewer/specs/archived/109-v50-clean-room-audit/quickstart.md` without launching it -- done against the real plan above; the command is documented, not executed
