...
- [ ] T049 [P] Update `wow-viewer/specs/archived/140-terrain-paste-motif-archaeology/quickstart.md` with only validated commands after G0/G1.
- [ ] T050 [P] Add deterministic run-summary and visual-review paths to `wow-viewer/specs/archived/140-terrain-paste-motif-archaeology/contracts/motif-pipeline.schema.md`.
