...
**Input**: Design documents from `wow-viewer/specs/archived/147-minimap-fog-instancing/`
...
- [x] T001 Record the current dirty-tree boundary in `wow-viewer/specs/archived/147-minimap-fog-instancing/research.md`; preserve `wow-viewer/imgui.ini` and unrelated changes.
- [ ] T002 Review the existing Spec 136, 137, and 142 task ownership and add cross-links in `wow-viewer/specs/archived/147-minimap-fog-instancing/plan.md` without changing those specs' completed claims.
- [ ] T003 Add the pure contract types described in `wow-viewer/specs/archived/147-minimap-fog-instancing/data-model.md` only where an existing core/runtime owner does not already provide the same state; do not create duplicate format or lighting readers.
- [ ] T004 Add a focused validation entrypoint or test naming convention for Spec 147 in `wow-viewer/specs/archived/147-minimap-fog-instancing/quickstart.md`, so a zero-test filter cannot be mistaken for proof.
...
- [ ] T029 [US4] Update `wow-viewer/specs/archived/147-minimap-fog-instancing/quickstart.md` with the final focused test names, user-run client/build capture fields, and explicit proof limitations.
