...
- [ ] T001 Read the existing `profile-render` report path and record the current stage/workload fields in `specs/archived/150-alpha-renderer-performance/research.md`.
...
- [ ] T003 [P] Prepare one fixed 0.5.3 control-scene identity in `specs/archived/150-alpha-renderer-performance/quickstart.md` without committing client data or reports.
...
- [ ] T018 [P] Update `specs/archived/150-alpha-renderer-performance/quickstart.md` with final focused test and profile commands.
