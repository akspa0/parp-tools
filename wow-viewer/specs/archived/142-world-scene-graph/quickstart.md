...
- `LastSelectedTiles` is the directional active submission set. Its size follows the ADT Detail
  ...
  WMO/MDX object admission. The active tile and the largest complete camera-centered square
  supported by the budget are admitted first: 3×3 for budgets from 9 through 24, and 5×5 at 25.
