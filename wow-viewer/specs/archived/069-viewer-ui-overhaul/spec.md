...
> **ARCHIVED 2026-09-23 — superseded.** Tab-bar design never built; replaced by the Workbench navigator (231). Successor: [Epic 251](../../251-epic-viewer-ux-and-code-health/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-E.md)); they are not implementation authority.
