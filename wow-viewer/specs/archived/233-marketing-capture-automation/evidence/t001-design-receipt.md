...
|---|---:|---|
| `Get-Content -Raw specs/archived/233-marketing-capture-automation/contracts/feature-tour-recipe.schema.json \| ConvertFrom-Json; Get-Content -Raw specs/archived/233-marketing-capture-automation/contracts/authoring-handoff.schema.json \| ConvertFrom-Json` | 0 | `contracts-json=pass` |
