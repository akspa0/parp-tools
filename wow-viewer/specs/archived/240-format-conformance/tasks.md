...
**Input**: `specs/archived/240-format-conformance/` (spec, plan, research)
...
- [ ] T001 Create evidence folder with receipt format (build identity, command, counts) in specs/archived/240-format-conformance/evidence/README.md
- [ ] T002 [P] Rerun `inspect casc wmo-survey` on 1.60.1.69876 and save the output as specs/archived/240-format-conformance/evidence/wmo-survey-2026-09-17.txt (research.md R2 quotes the post-fix run; it was not saved to disk)
...
- [ ] T012 [US1] SC-001: reproduce research.md R2 counts; record full-product report in specs/archived/240-format-conformance/evidence/survey-baseline-1.60.1.md and update research.md unmeasured rows (high_res_holes, BLP formats, companions)
...
- [ ] T016 [US2] Measure the shader-23 blend: on Orgrimmar2FrontGate and 10DU_HallUldamanUprez_Main01, correlate texture_2/texture_3/color_2/flags_2 usage with MOCV alpha and UV sets; record in specs/archived/240-format-conformance/evidence/shader23.md
...
- [ ] T021 [US2] SC-003 captures of 11DL_Dalaran, Orgrimmar2FrontGate, GoldshireInn before/after in specs/archived/240-format-conformance/evidence/wmo-captures.md (operator witness)
...
- [ ] T027 [US4] Per-chunk consumption audit: which Warcraft.NET-parsed chunks reach src/viewer/WoWViewer/Rendering/WarcraftNetM2Adapter.cs and WowViewerM2RuntimeBridge.cs; record in specs/archived/240-format-conformance/evidence/m2-chunk-consumption.md
- [ ] T028 [P] [US4] LDV1-driven skin LOD selection if T027 shows it unused
- [ ] T029 [P] [US4] Investigate the 15 "ok but 0 sections" models from map-survey; record cause in specs/archived/240-format-conformance/evidence/m2-zero-sections.md
...
- [ ] T035 [P] Study WTL (MIT): CASC product/branch handling, listfile and naming (WoWNamingLib), file linking; record in specs/archived/240-format-conformance/evidence/reference-study.md
...
- [ ] T037 Propose confirmed wiki corrections (e.g. MCMT layer note vs. 8-layer data, MGI2 layout) in specs/archived/240-format-conformance/evidence/wiki-notes.md

## Polish

- [ ] T038 Rerun the full survey; update research.md states and SC status
- [x] T039 Update specs/STATUS.md v0.6 scope and specs/archived/status-history/2026-09-06-active-epics.md membership
