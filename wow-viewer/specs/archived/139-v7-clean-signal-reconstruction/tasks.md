...
- [ ] T001 Record the v7 clean-signal feature identity and artifact paths in `wow-viewer/.specify/feature.json` and `wow-viewer/specs/archived/139-v7-clean-signal-reconstruction/`.
- [x] T002 [P] Add the v7 clean-signal schema contract to `wow-viewer/specs/archived/139-v7-clean-signal-reconstruction/contracts/v7-clean-signal.schema.md` and keep it aligned with the model/data code.
...
- [ ] T035 Run focused `ruff`, `py_compile`, and v60 pytest checks and record results in `wow-viewer/specs/archived/139-v7-clean-signal-reconstruction/quickstart.md`.
