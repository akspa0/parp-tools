...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Live clean-signal lane; residue cross-tile family regression, promotion. Successor: [Epic 254](../../254-epic-datasets-and-terrain-ml/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-A2.md)); they are not implementation authority.
