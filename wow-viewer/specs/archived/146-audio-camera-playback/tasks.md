...
**Input**: Design documents from `wow-viewer/specs/archived/146-audio-camera-playback/`
...
- [ ] T007 Add backend-neutral interfaces for asset resolution, capability probing, playback, runtime ownership, and capture bridging in `wow-viewer/specs/archived/146-audio-camera-playback/contracts/audio-runtime.md` and corresponding C# contract files.
...
- [ ] T030 [US4] Record representative client/build samples and candidate backend findings in `wow-viewer/specs/archived/146-audio-camera-playback/research.md` before adding historical-format support.
...
- [ ] T038 [P] Run the user-owned audible and synchronized capture matrix from `wow-viewer/specs/archived/146-audio-camera-playback/quickstart.md`.
