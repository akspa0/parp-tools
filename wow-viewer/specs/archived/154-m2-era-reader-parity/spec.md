...
> **ARCHIVED 2026-09-23 — superseded.** Absorbed by 235; US4 cross-era rig comparison parked. Successor: [Epic 248](../../248-epic-formats-and-conversion/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-D1.md)); they are not implementation authority.
