...
> **ARCHIVED 2026-09-23 — superseded.** Superseded by 126/133/139; parked residue FR-021 super-res, FR-010/FR-012. Successor: [Epic 254](../../254-epic-datasets-and-terrain-ml/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-A2.md)); they are not implementation authority.
