...
| `wow-viewer/specs/archived/212-spatial-ui-shell/*` | 2026-09-06 operator correction: decorative-instrumentation tasks struck; scope re-aimed at ImGui panels on camera-frame surfaces. |
