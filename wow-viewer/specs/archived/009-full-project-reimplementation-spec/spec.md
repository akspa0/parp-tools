...
> **ARCHIVED 2026-09-23 — cold (historical reference, no live residue).** Historical reimplementation reference; not an execution contract. Successor: [Epic 251](../../251-epic-viewer-ux-and-code-health/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-E.md)); they are not implementation authority.
