...
**Input**: `specs/archived/241-dat-v26-interchange/spec.md` · **Release**: v0.6 · **Branch**: `v0.5.4-dev`
...
- [ ] T001 Operator runs the viewer export on a real map and the checks in docs/architecture/adt-v26-format.md ("Writer and round trip"); record results in specs/archived/241-dat-v26-interchange/evidence/export-check.md
- [ ] T002 Plan: sidecar vs extension chunks for liquids, holes, area IDs, MCSE, MFBO, doodad sets, MTXP; record the decision and reason in specs/archived/241-dat-v26-interchange/plan.md
