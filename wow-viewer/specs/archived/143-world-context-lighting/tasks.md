...
**Input**: Design documents from `/specs/archived/143-world-context-lighting/`
...
- [ ] T001 [P] [SETUP] Record the active Spec 106/138 lighting ownership and build/profile matrix in `specs/archived/143-world-context-lighting/research.md`.
- [ ] T002 [P] [SETUP] Add the current AreaTable load/lookup diagnostics and MCNK source paths to `specs/archived/143-world-context-lighting/research.md`.
- [ ] T003 [SETUP] Audit existing WMO root/group fixtures and reference readers for a profile-proven WMOAreaID source; record unresolved profiles in `specs/archived/143-world-context-lighting/research.md`.
- [ ] T004 [SETUP] Add a focused validation inventory for early, 1.x/3.x, and 4.x client roots in `specs/archived/143-world-context-lighting/quickstart.md` without embedding machine-local paths.
...
- [x] T015 [US1] Run the focused area-context tests and isolated viewer build; record the proof and remaining real-client gap in `specs/archived/143-world-context-lighting/quickstart.md`.
...
- [ ] T039 [US5] Run focused tests and the isolated viewer build; record results in `specs/archived/143-world-context-lighting/quickstart.md`.
- [ ] T040 [US5] Hand the user the PowerShell real-client matrix from `specs/archived/143-world-context-lighting/quickstart.md` and review returned ADT/WMO/camera/lighting/frame-stage evidence.
...
- [ ] T042 [P] Update `specs/archived/143-world-context-lighting/spec.md`, `plan.md`, `research.md`, and `data-model.md` with the final proven profiles and known gaps.
