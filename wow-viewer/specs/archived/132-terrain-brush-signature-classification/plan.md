...
**Input**: Feature specification from `/specs/archived/132-terrain-brush-signature-classification/spec.md`
...
└── specs/archived/132-terrain-brush-signature-classification/
