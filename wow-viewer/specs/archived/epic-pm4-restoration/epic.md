...
> **ARCHIVED 2026-09-23 — superseded.** Old epic index; members and residue now owned by the new epic. Successor: [Epic 253](../../253-epic-pm4-navmesh-research/spec.md). Status lines and checkboxes below are historical and were audited against the code ([reconciliation ledger](../reconciliation-2026-09-23/README.md)); they are not implementation authority.
