...
**Input**: Feature specification from `specs/archived/237-adt-v26-terrain/spec.md`
...
> set `$env:SPECIFY_FEATURE_DIRECTORY = 'specs/archived/237-adt-v26-terrain'`.
...
```text
specs/archived/237-adt-v26-terrain/
├── spec.md
├── plan.md              # this file
