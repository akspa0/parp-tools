...
**Input**: Design documents from `specs/archived/148-world-simulator/`
...
- [ ] T010 [US1] Run focused audio/area/minimap tests and the cross-platform Debug viewer build;
  update `specs/archived/148-world-simulator/`, `memory-bank/activeContext.md`, and `memory-bank/progress.md`
