...
> **ARCHIVED 2026-09-23 — complete (code verified; any listed operator gates carried forward).** LIT documentation drafted; wiki submission is an operator action. Successor: [Epic 248](../../248-epic-formats-and-conversion/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-G2.md)); they are not implementation authority.
