...
**Input**: Feature specification from `/specs/archived/149-pm4-region-audio-controls/spec.md`
...
```text
specs/archived/149-pm4-region-audio-controls/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
...
specs/archived/149-pm4-region-audio-controls/      # design and implementation handoff
```
