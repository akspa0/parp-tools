...
- [x] T001 [US1] Create the dated source-audit inventory and screenshot matrix in `specs/archived/227-ui-reaudit/surface-inventory-v2.md`. Receipt: `evidence/t001-source-audit.md`.
- [x] T002 [US1] Compare every Spec 223 retire/merge disposition against its current source route and record unresolved rows in `specs/archived/227-ui-reaudit/surface-inventory-v2.md`. Receipt: `evidence/t002-spec223-reconciliation.md`.
- [ ] T003 [US1] Capture the current-build, profile-by-profile screenshot and interaction matrix in `specs/archived/227-ui-reaudit/evidence/screenshots/` and link the records from `specs/archived/227-ui-reaudit/surface-inventory-v2.md`.
- [ ] T004 [US1] Re-check the inventory gate and record the criterion-to-evidence receipt in `specs/archived/227-ui-reaudit/evidence/t004-inventory-gate.md`.
...
- [ ] T005 [US2] Select the first inventory-approved surface and add its source path, replacement row, and three-interaction route to `specs/archived/227-ui-reaudit/surface-inventory-v2.md`.
...
- [ ] T007 [US2] Run the affected focused test suite and `dotnet build I:/parp/parp-tools/wow-viewer/WowViewer.slnx -c Debug`; record the receipt in `specs/archived/227-ui-reaudit/evidence/`.
- [ ] T008 [US2] Record the operator screenshot and reachability result for the selected surface in `specs/archived/227-ui-reaudit/evidence/screenshots/`.
...
- [ ] T009 [US3] Map weak-signal amplifier entry points to the Spec 194 owner in `specs/archived/227-ui-reaudit/surface-inventory-v2.md` before converting any duplicate entry to a route/link.
- [ ] T010 [US3] Apply the approved weak-signal route/link or retirement in the inventory-named source file and record a focused build receipt in `specs/archived/227-ui-reaudit/evidence/`.
- [ ] T011 [US3] Run the minimap click/teleport matrix and select the canonical host in `specs/archived/227-ui-reaudit/surface-inventory-v2.md`; do not infer the result from shared renderer code.
- [ ] T012 [US3] Apply the inventory-approved minimap route/link or interaction repair in the inventory-named source file and record source/build plus operator input evidence in `specs/archived/227-ui-reaudit/evidence/`.
- [ ] T013 [US3] Map each Inspector object type and duplicate readout to its single authoritative page in `specs/archived/227-ui-reaudit/surface-inventory-v2.md`.
- [ ] T014 [US3] Apply the inventory-approved Inspector route/link or retirement in the inventory-named source file and record focused source/build and operator evidence in `specs/archived/227-ui-reaudit/evidence/`.
...
- [ ] T015 [US4] Record the accepted per-profile action order and corresponding inventory rows in `specs/archived/227-ui-reaudit/surface-inventory-v2.md`.
- [ ] T016 [US4] Update the post-audit UI guidance in `wow-viewer/docs/WoWViewer/USERGUIDE.md` from the accepted inventory.
- [ ] T017 [US4] Record the final profile-by-profile screenshot comparison and acceptance receipt in `specs/archived/227-ui-reaudit/evidence/`.
