...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Residue: FR-008..FR-014 profile unification, FR-001..FR-007 animation addressing. Successor: [Epic 248](../../248-epic-formats-and-conversion/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-D1.md)); they are not implementation authority.
