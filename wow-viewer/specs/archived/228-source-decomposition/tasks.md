...
- [ ] T001 Record baseline counts, all present over-budget files, and the first selection candidate's callers in `specs/archived/228-source-decomposition/evidence/t001-source-baseline.md`.
- [ ] T002 Record the proposed selection boundary's current public routes and UI-authority dependency on Spec 227 T004 in `specs/archived/228-source-decomposition/evidence/t002-selection-boundary.md`.
...
- [ ] T003 Verify and cite the accepted Spec 227 T004 selection/Inspector authority before any Spec 228 source change in `specs/archived/228-source-decomposition/evidence/t003-ui-authority-gate.md`.
...
- [ ] T007 [US3] Run `dotnet test tests/WowViewer.Core.Tests/WowViewer.Core.Tests.csproj -c Debug --filter "FullyQualifiedName~WorldSceneSelection"` and record the result in `specs/archived/228-source-decomposition/evidence/t007-selection-contract.md`.
...
- [ ] T010 [US1] Run focused `WorldSceneSelection` tests, `dotnet build I:/parp/parp-tools/wow-viewer/WowViewer.slnx -c Debug`, and `dotnet test I:/parp/parp-tools/wow-viewer/WowViewer.slnx -c Debug`; record exit status and before/after counts in `specs/archived/228-source-decomposition/evidence/t010-worldscene-selection-extraction.md`.
- [ ] T011 [US1] Obtain and record the operator hover/click smoke on a configured client root in `specs/archived/228-source-decomposition/evidence/t011-worldscene-selection-smoke.md`; leave the task open if a target identity, terrain occlusion, or Inspector route differs.
...
- [ ] T012 [US2] Choose one candidate only after the relevant Spec 223 runtime gate and Spec 227 authority row are recorded; write the behavior matrix, current owner, and intended service path in `specs/archived/228-source-decomposition/evidence/t012-viewerapp-candidate.md`.
- [ ] T013 [US2] Add the candidate-specific implementation/test/operator-smoke tasks as a dated approved amendment to `specs/archived/228-source-decomposition/tasks.md`; do not implement capture, camera, sidebar, editor, or PM4 extraction from an assumed future plan.
...
- [ ] T015 Re-run the source-size inventory and record that no new source file exceeds the budget and no legacy breach grew in `specs/archived/228-source-decomposition/evidence/t015-context-safety-audit.md`.
