...
**Input**: Design documents from `/specs/archived/141-terrain-method-translation/`
...
- [x] T001 Record the Spec 141 feature identity and artifact roots in `wow-viewer/.specify/feature.json` and `wow-viewer/specs/archived/141-terrain-method-translation/`.
...
- [x] T008 [P] [US1] Encode DSM2DTM, ResDepth, SMRF, CSF, aerial object-mask, and Prithvi records in `wow-viewer/data-harvester/src/harvester/v60/terrain_method_translation.py` using the links and decisions in `specs/archived/141-terrain-method-translation/research.md`.
...
- [ ] T021 [US3] **USER RUNS** the dry plan, then any explicitly confirmed corpus/training/evaluation command after the contract tests pass; record the result in `specs/archived/141-terrain-method-translation/quickstart.md`.
...
- [ ] T025 [US4] Add a concise lead-recording section to `wow-viewer/specs/archived/141-terrain-method-translation/quickstart.md`.
...
- [ ] T027 [P] Update `wow-viewer/specs/archived/141-terrain-method-translation/research.md` with any source-access or reproduction changes discovered during implementation.
- [x] T028 Run focused `ruff`, `py_compile`, and v60 pytest checks; record exact commands and results in `wow-viewer/specs/archived/141-terrain-method-translation/quickstart.md`.
