...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Residue US4 research-lead ledger. Successor: [Epic 254](../../254-epic-datasets-and-terrain-ml/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-A2.md)); they are not implementation authority.
