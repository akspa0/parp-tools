...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Correlation + fingerprint matching shipped; placement restore shipped outside the spec (inspect pm4 restore-placements). Residue: T034-T036, rotation. Successor: [Epic 253](../../253-epic-pm4-navmesh-research/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-B.md)); they are not implementation authority.
