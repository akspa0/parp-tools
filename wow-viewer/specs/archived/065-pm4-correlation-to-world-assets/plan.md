...
**Branch**: `065-pm4-correlation-to-world-assets` | **Date**: 2026-06-17 (revised) | **Spec**: `specs/archived/065-pm4-correlation-to-world-assets/spec.md`
...
```
wow-viewer/
├── specs/archived/065-pm4-correlation-to-world-assets/
│   ├── spec.md
│   ├── plan.md
│   └── tasks.md
