...
**Owner Spec**: `specs/archived/235-legacy-mdx-m2-rendering/spec.md`
**Plan**: `specs/archived/235-legacy-mdx-m2-rendering/plan.md`
...
- [x] T040 [P] Author receipt in `specs/archived/235-legacy-mdx-m2-rendering/evidence/phase1-reader-unification.md` documenting changes, commands, and outputs.
