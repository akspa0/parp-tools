...
## Reused verbatim from Spec 104 (`specs/archived/104-legacy-m2-rendering/data-model.md`)
...
## Reused verbatim from Spec 154 (`specs/archived/154-m2-era-reader-parity/data-model.md`)
