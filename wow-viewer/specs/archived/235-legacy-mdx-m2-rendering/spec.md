...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Phases 0-4 landed; residue FR-014, FR-015, US4, US5 + visual gates. Successor: [Epic 248](../../248-epic-formats-and-conversion/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-D1.md)); they are not implementation authority.
...
Before planning could start, checking `specs/archived/status-history/2026-09-06-active-epics.md` Epic 4 and
