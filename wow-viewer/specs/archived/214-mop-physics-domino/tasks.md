...
- [ ] T002 Capture the configured real-client build identity and candidate asset hashes in `specs/archived/214-mop-physics-domino/evidence/real-client-manifest.md`
- [x] T002a Audit existing physics-adjacent implementation and record confirmed gaps in `specs/archived/214-mop-physics-domino/evidence/current-implementation-audit.md`

## Phase 2 — Foundational evidence gate

- [x] T003 Enumerate callers of `FUN_00c29680` and record source-path/header/line attribution only in `specs/archived/214-mop-physics-domino/evidence/domino-caller-map.md`
- [x] T004 Trace the `Physics.cpp` / `PhysData.cpp` adapter boundary without decoding Domino algorithms in `specs/archived/214-mop-physics-domino/evidence/physics-adapter-contract.md`
- [x] T005 Trace model-sidecar discovery from the confirmed adapter and record the actual model association plus malformed-data behaviour in `specs/archived/214-mop-physics-domino/evidence/physics-adapter-contract.md`
...
- [x] T006 [US1] Consolidate verified layouts, data flow, update observations, adapter boundary, and explicit unknowns into `specs/archived/214-mop-physics-domino/evidence/physics-contract.md`
- [x] T007 [P] [US1] Evaluate exact BepuPhysics v2 and Jitter2 versions for license, deterministic stepping, collision scope, and cloth route in `specs/archived/214-mop-physics-domino/evidence/solver-selection.md`
- [x] T008 [US1] Review `specs/archived/214-mop-physics-domino/evidence/physics-contract.md` against FR-001 through FR-005 and record the Phase 0 pass/block decision in `specs/archived/214-mop-physics-domino/tasks.md`
...
- [x] T012 Generate sidecar-parser and solver-adapter implementation tasks only after T005 and T007 are marked complete in `specs/archived/214-mop-physics-domino/tasks.md`
