...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Decode phases open; partially advanced by 188/189 research. Successor: [Epic 253](../../253-epic-pm4-navmesh-research/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-B.md)); they are not implementation authority.
