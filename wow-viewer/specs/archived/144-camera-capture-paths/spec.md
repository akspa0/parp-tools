...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Code complete; 5 user-run capture proofs owed. Successor: [Epic 252](../../252-epic-world-simulation-and-audio/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-G1.md)); they are not implementation authority.
