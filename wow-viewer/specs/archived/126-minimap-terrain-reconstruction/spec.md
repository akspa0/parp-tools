...
> **ARCHIVED 2026-09-23 — superseded.** Core ambition moved to 139; parked residue US5 seams, US6/US8 texture tier. Successor: [Epic 254](../../254-epic-datasets-and-terrain-ml/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-A2.md)); they are not implementation authority.
