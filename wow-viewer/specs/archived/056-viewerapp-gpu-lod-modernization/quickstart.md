...
`wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/baselines/` contains the pre-spec capture hashes:
...
- Spec: `specs/archived/056-viewerapp-gpu-lod-modernization/spec.md`
- Plan: `specs/archived/056-viewerapp-gpu-lod-modernization/plan.md`
- Research: `specs/archived/056-viewerapp-gpu-lod-modernization/research.md`
- Data model: `specs/archived/056-viewerapp-gpu-lod-modernization/data-model.md`
- Contracts: `specs/archived/056-viewerapp-gpu-lod-modernization/contracts/`
- Tasks: `specs/archived/056-viewerapp-gpu-lod-modernization/tasks.md` (Phase 2 output, generated by `speckit-tasks`)
