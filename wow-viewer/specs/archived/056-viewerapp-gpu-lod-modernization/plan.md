...
**Branch**: `056-viewerapp-gpu-lod-modernization` | **Date**: 2026-06-10 | **Spec**: [`specs/archived/056-viewerapp-gpu-lod-modernization/spec.md`](spec.md)

**Input**: Feature specification from `specs/archived/056-viewerapp-gpu-lod-modernization/spec.md`. Locked decisions D1–D7 are in the spec.
...
```text
specs/archived/056-viewerapp-gpu-lod-modernization/
...
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/contracts/RenderScene.md` (new — contract surface)
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/contracts/RenderBackend.md` (new)
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/contracts/RenderResources.md` (new)
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/contracts/TextureCache.md` (new)
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/research.md` (Phase 0 research — existing `WorldTerrainLodSelector` and `WorldObjectVisibilityCollector` consumption plan)
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/data-model.md` (Phase 1 data model — `RenderScene`, `RenderBackend`, `RenderResources`)
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/quickstart.md` (Phase 1 quickstart — validation commands and parity baselines)
...
- A deterministic capture baseline is recorded for `0_5_3_3368` Azeroth and `3_3_5_12340` Azeroth through the *current* shared renderer + legacy viewer-app renderer (whatever the pre-spec renderer is), and the baseline image hashes are stored under `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/baselines/`.
...
- `wow-viewer/specs/archived/056-viewerapp-gpu-lod-modernization/quickstart.md` (existing — extend with the new validation commands)
