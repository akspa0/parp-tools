...
- [x] T001 Record the active viewer-stabilization route and contract links in `specs/archived/110-viewer-stabilization/plan.md`
...
- [x] T012 [US1] Run focused fog tests and the Debug Viewer build documented in `specs/archived/110-viewer-stabilization/quickstart.md`
...
- [x] T018 [US1] [US6] Run focused fog/minimap tests and the Debug Viewer/Harvest build documented in `specs/archived/110-viewer-stabilization/quickstart.md`
- [ ] T019 [US1] [US6] [US7] Run the two-map LIT/no-LIT time-of-day, overlay, synthesized-minimap, visible-fog-slider, and Archeology playback visual proof in `specs/archived/110-viewer-stabilization/quickstart.md`
...
- [x] T023 [US7] Build the Viewer without replacing a running user app in `specs/archived/110-viewer-stabilization/quickstart.md`
...
- [ ] T034 [US2] Run focused M2 reader/runtime tests and Debug build from `specs/archived/110-viewer-stabilization/quickstart.md`
...
- [x] T045 Update task states and exact proof commands in `specs/archived/110-viewer-stabilization/tasks.md`
