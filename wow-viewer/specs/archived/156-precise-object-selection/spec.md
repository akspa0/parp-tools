...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Cursor covered by 210/211; residue triangle-precise picking (252), PM4 match library (253). Successor: [Epic 252](../../252-epic-world-simulation-and-audio/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-G2.md)); they are not implementation authority.
...
accurate 1.3% of the time (`specs/archived/046-pm4-asset-matching`, `specs/archived/065-pm4-correlation-to-world-assets`,
