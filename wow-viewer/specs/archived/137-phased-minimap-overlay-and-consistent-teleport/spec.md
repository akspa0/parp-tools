...
> **ARCHIVED 2026-09-23 — superseded.** Minimap phase tiles via PhaseLayers; Armed teleport via 147 US1. Successor: [Epic 250](../../250-epic-reconstruction-and-editor-platform/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-G1.md)); they are not implementation authority.
