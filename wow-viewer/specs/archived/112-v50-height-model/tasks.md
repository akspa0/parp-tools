...
**Input**: Design documents from `specs/archived/112-v50-height-model/`
...
- [x] T013 [US1] Run the coverage audit on both rebuilt stores, record both reports under
  ...
  coverage in `specs/archived/112-v50-height-model/quickstart.md` §1.4
...
- [x] T016 [US2] Build the real dual-source curriculum from the rebuilt stores (CPU-side,
  ...
  split, and record the proof in `specs/archived/112-v50-height-model/quickstart.md`
...
- [ ] T021 [US3] **USER RUNS**: authored-only baseline training on the unaffected rows of the
  ...
  in `specs/archived/112-v50-height-model/quickstart.md` Phase 2); assistant reviews the resulting
...
- [x] T023 Run the full focused suite (`tests/v50/`, `tests/test_v50_contract.py`,
  ...
  `specs/archived/112-v50-height-model/quickstart.md`; update `wow-viewer/memory-bank/activeContext.md` and
