...
> **ARCHIVED 2026-09-23 — open residue folded into an epic.** Entire spec open (merged with 178). Successor: [Epic 251](../../251-epic-viewer-ux-and-code-health/spec.md). Status lines and checkboxes below are historical and were audited against the code ([audit](../reconciliation-2026-09-23/audit/batch-G2.md)); they are not implementation authority.
