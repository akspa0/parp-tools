...
**Input**: Design documents from `/specs/archived/117-wdl-lattice-prior/`
...
- [x] T019 [P] Update `specs/archived/117-wdl-lattice-prior/data-model.md`, `contracts/cli-contract.md`, and `quickstart.md` to use the REAL store array names (`wdl_outer_17`/`wdl_inner_16`/`wdl_outer_present`/`wdl_inner_present`, discovered already-live in the C# stream — not the originally-drafted `wdl_lattice_outer17` etc.) and the REAL argparse of `spec117_train_lattice.py`/`spec117_lattice_to_feature_map.py`, per this project's "verify docs against real argparse" convention
