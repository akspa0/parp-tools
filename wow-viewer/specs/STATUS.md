...
| 5 | [142 World scene graph](142-world-scene-graph/spec.md) | In progress | Validate active-tile WMO/MDX object admission with a user-run production capture before further renderer redesign |
