...
2026-09-25, E1 smoke owed. R-10's after-capture lands before U-01 step E2.
...
| [249 Renderer Performance, Lighting & Correctness](249-epic-renderer-performance-and-correctness/spec.md) | Benchmarks and receipts, batching/instancing, WMO admission, streaming, lighting, correctness | R-01…R-38, R-9x | **R-10 P1**: code landed 2026-09-23; baseline/after captures owed; rest pending |
...
| [251 Viewer UX, Shell & Code Health](251-epic-viewer-ux-and-code-health/spec.md) | UI consolidation, god-class extraction, governance, automation surface | U-01…U-34, U-90 | **U-01 P1**: E1 code landed 2026-09-25 (`WorldScene.cs` 17,175 → 8,326; smoke owed); rest pending |
