...
| [251 Viewer UX, Shell & Code Health](251-epic-viewer-ux-and-code-health/spec.md) | UI consolidation, god-class extraction, governance, automation surface | U-01…U-34, U-90 | **U-01 P1**: E1 + E3 + ViewerApp campaign landed 2026-09-25 (`WorldScene.cs` 17,175 → 8,326; `ViewerApp` class 42,973 → 2,512 lines); smoke owed; rest pending |
