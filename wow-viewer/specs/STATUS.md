...
|---|---|---|---|
| 1 | [153 Renderer hitch and MDX batching](153-renderer-hitch-and-batching/spec.md) | Draft; diagnosis COMPLETE with measurements, fixes not started | Phase 0: capture Stranglethorn sub-probes to name the ~212ms periodic stall inside PrepareObjectPhase. Phases 1/3/5 are independent and can start in parallel |
