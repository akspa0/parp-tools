...
```text
Setup -> Foundation -> US1 -> Paint-order evidence -> US2 -> US3 -> US4 -> US5 -> Polish
...
- [ ] T005 Define `TilesetProfile`, `MotifCandidate`, `PasteFamily`, and `GuidanceBundle` in `wow-viewer/data-harvester/src/harvester/v60/terrain_motif_models.py`.
...
- [ ] T027 [US2] Implement the retrieval report and match-atlas CLI in `wow-viewer/data-harvester/scripts/v60_retrieve_terrain_motifs.py`.
...
- [ ] T039 [P] Update `wow-viewer/specs/140-terrain-paste-motif-archaeology/quickstart.md` with only validated commands after G0/G1.
- [ ] T040 [P] Add deterministic run-summary and visual-review paths to `wow-viewer/specs/140-terrain-paste-motif-archaeology/contracts/motif-pipeline.schema.md`.
- [ ] T041 Update `wow-viewer/memory-bank/activeContext.md`, `wow-viewer/memory-bank/workstream-terrain-ml.md`, and `wow-viewer/memory-bank/progress.md` after each completed phase.
