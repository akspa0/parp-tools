...
- [x] **T009**: Add Alpha 0.5.3 Rosetta file-axis WDT byte patcher and minimap object-band marker regressions without changing renderer, terrain-loading, or protected writer code.
