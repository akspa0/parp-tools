...
- [ ] T061 [US1] USER RUN: materialize the frozen coarse checkpoint's outputs, then train/evaluate the detailer against the coarse-only baseline and record the verdict in `specs/114-direct-terrain-reconstruction/research.md`
