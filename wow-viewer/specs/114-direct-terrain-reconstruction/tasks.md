...
- [ ] T063 [US1] Spec and implement the multi-frequency band-split detailer variant (octave-band residual stack) in `data-harvester/src/harvester/v50/geometry_detailer_model.py` and its trainer, with the same coarse-only baseline and ≥5% gate
