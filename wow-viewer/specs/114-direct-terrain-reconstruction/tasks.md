...
- [ ] T057 [US1] USER RUN: train the spectral-guidance ablation (`--spectral-weight 0.1 --multiscale-weight 0.25`) as `mit_b0-authored-v2-spectral` and compare against the frozen `mit_b0-authored-v1` metrics per the research.md spectral-bias record (ID assigned in creation order; placement is Phase 3)
