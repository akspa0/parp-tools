...
- [x] T027c [US6] Replace the fixed-bias authored solar direction with a shared terrain/raster-axis path that is vertical at noon and top-left after noon; include the failed pipeline stage in tile manifest diagnostics; add focused direction proof and build Harvest/Viewer.
