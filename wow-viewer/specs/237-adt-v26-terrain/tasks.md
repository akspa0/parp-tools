...
**Input**: `specs/237-adt-v26-terrain/` (spec, plan, research, data-model, contracts/cli-contract.md, quickstart)
...
- [ ] T001 Create evidence folder and README stating the receipt format (command, root, file count, SHA-256 of file list) in specs/237-adt-v26-terrain/evidence/README.md
...
- [ ] T005 Grep all `AdtV23` switch/predicate sites across src/ and tools/ and extend each one explicitly for the new kinds; list the sites touched in specs/237-adt-v26-terrain/evidence/t005-kind-sites.md
...
- [ ] T050 [US0] 🗂 Operator visual gate: screenshots, crack check, inner-grid sanity note in specs/237-adt-v26-terrain/evidence/fastpath-wireframe.md
...
- [ ] T026 [US2] 🗂 Run layout-probe on the corpus, record winners and margins, and fix the reader to the winning layouts in specs/237-adt-v26-terrain/evidence/phase1-layout-probe.md and src/core/WowViewer.Core.IO/Maps/AdtAhdrReader.cs
...
- [ ] T033 [US2] 🗂 Phase 1 gate receipt with SC-002–SC-006 numbers in specs/237-adt-v26-terrain/evidence/phase1-decode.md
...
- [ ] T052 [P] [US3] Re-run evidence/scripts/names_to_fdid_v26.py against the refreshed listfile and record coverage in specs/237-adt-v26-terrain/evidence/asset-resolution.md
...
- [ ] T040 [US3] 🗂 Operator visual gate with screenshots (seams, blending, objects on ground) in specs/237-adt-v26-terrain/evidence/phase2-render.md

## Phase 6: User Story 4 — Existing formats unaffected (P2)

- [ ] T044 [P] Investigate the unexplained revision-26 values (ALOC[0]=2869, ALOC fields 3/4, AOCH all-zero, ADST, AHDR+0x14 = 8396383) and record the results in specs/237-adt-v26-terrain/research.md R14
- [ ] T041 [US4] Run the full test suite and open one 0.5.3 Alpha map and one 3.3.5 LK map; record results in specs/237-adt-v26-terrain/evidence/phase2-regression.md

## Phase 7: Polish

- [ ] T042 [P] Document `adt-ahdr` commands, then diff docs/CLI-TOOLS.md and specs/237-adt-v26-terrain/quickstart.md against the real argument parser
