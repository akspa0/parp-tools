...
public sealed class McnkFlagDecoderTests
{
    ...
    [InlineData(0x00u, (byte)0x01, AdtLiquidBasicType.Ocean)]
    [InlineData(0x00u, (byte)0x03, AdtLiquidBasicType.Slime)]
    [InlineData(0x00u, (byte)0x04, AdtLiquidBasicType.Water)]
    [InlineData(0x00u, (byte)0x06, AdtLiquidBasicType.Magma)]
    [InlineData(0x00u, (byte)0x0F, AdtLiquidBasicType.Water)]
    [InlineData(0x20u, (byte)0x00, AdtLiquidBasicType.Slime)]
    [InlineData(0x20u, (byte)0x04, AdtLiquidBasicType.Water)]
    [InlineData(0x10u, (byte)0x00, AdtLiquidBasicType.Magma)]
    [InlineData(0x10u, (byte)0x01, AdtLiquidBasicType.Ocean)]
    [InlineData(0x10u, (byte)0x06, AdtLiquidBasicType.Magma)]
    [InlineData(0x08u, (byte)0x00, AdtLiquidBasicType.Ocean)]
    [InlineData(0x08u, (byte)0x06, AdtLiquidBasicType.Magma)]
